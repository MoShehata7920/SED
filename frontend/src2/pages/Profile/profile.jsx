        ...
        <div class="flex items-center space-x-4 p-2 mb-5 avatar-info">
            ...
            <div>
                ...
                <span class="text-sm tracking-wide flex items-center space-x-1 lable">
                    ...
                    </svg><span class="text-gray-600 text-xs lable">Verified</span>
                </span>
            </div>
        </div>

            {/* list for sidbar items */}

        <ul class="space-y-2 text-sm sid-items">
            <li>
                <a href="{}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline ">
                    ...
                    <span class="lable">My profile</span>
                </a>
            </li>
            <li>
                <a href="{}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                    ...
                    <span class="lable">My orders</span>
                </a>
            </li>
            <li>
                <a href="{}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                    ...
                    <span class="lable">Favourite</span>
                </a>
            </li>
            <li>
                <a href="{}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                    ...
                    <span class="lable">My wishlist</span>
                </a>
            </li>
            ...
            <li>
                <a href="{}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                    ...
                    <span class="lable">Personal messages</span>
                </a>
            </li>
            <li>
                <a href="{}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
