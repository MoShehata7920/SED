...
export default function Home() {
  ...
  return (
    <>
      ...
      <section>
        <div className="row ">
          <div className="col-xxl-3 col-xl-6 col-md-6 col-sm-12  col-12 ">
          ...
          <div className="col-xxl-3 col-xl-6 col-md-6 col-sm-12  col-12">
            <Link to={"a"} className=" text-decoration-none">
              <div className="catogiry-div  position-relative ">
                ...
                <div className=" catogiry-text text-white">
      ...
      <section className="pt-5">
        <OwlCarousel className="slider-style  owl-theme " {...options2}>
      ...
      <section className="pt-5">
        <OwlCarousel className="slider-style owl-theme " {...options2}>
          <div class="item text-center">
            <h1 className=" fs-10 ">EXCHANGE</h1>
            <Link to={"a"}>
              <p className="text-black fs-3 "> see all</p>
            </Link>
          </div>
