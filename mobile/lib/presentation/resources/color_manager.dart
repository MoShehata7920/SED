...
class ColorManager {
  ...
  static Color lightPrimary = const Color(0xff00355f);
  static Color secondLightPrimary = const Color(0xff00355f);
  static Color thirdLightPrimary = const Color(0xff00355f);
